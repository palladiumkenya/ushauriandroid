...
public class Registration2otp extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    Dialogs dialogs;
    Dialog mydialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_registration2otp);

        Intent intent = getIntent();
       PhoneNoSend= intent.getStringExtra("PhoneNo");
        try {

            mydialog = new Dialog(Registration2otp.this);
            dialogs=new Dialogs(Registration2otp.this);
    ...
    public void addListenerOnChkTracer() {
        ...
        cktracer.setOnClickListener(new View.OnClickListener() {
    ...
    public void initialise() {
        ...
        try {
            acs=new AccessServer(Registration2otp.this);
            sm = new SendMessage(Registration2otp.this);
            istracer = false;
           // userphoneE = (EditText) findViewById(R.id.usr_phone);
            ...
            requestPerms = new RequestPerms(Registration2otp.this, this);
...
//                    spinnerDialog=new SpinnerDialog(CreateUser.this,items,"Select or Search City","Close Button Text");// With No Animation
                    spinnerDialog = new SpinnerDialog(Registration2otp.this, y, "Select Affiliation", R.style.DialogAnimations_SmileWindow, "Close");// With 	Animation
    ...
    public void cancelDetails() {
        ...
        try {
            ...
            cancel.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
// TODO Auto-generated method stub
                    Intent ii = new Intent(Registration2otp.this, LoginActivity.class);
                    startActivity(ii);
                }
            });
...
// TODO Auto-generated method stub
                  ...
                  if(mfllist.size()<1){
                        ...
                        Toast.makeText(Registration2otp.this, "mflcode is required", Toast.LENGTH_SHORT).show();
                    }

                    else if (ucsfOptionsL.isShown() && trcidnoE.getText().toString().trim().isEmpty()) {
                        trcidnoE.setError("ID number is required");
                        Toast.makeText(Registration2otp.this, "ID number is required", Toast.LENGTH_SHORT).show();
                        ...
                        Toast.makeText(Registration2otp.this, "Security hint is required", Toast.LENGTH_SHORT).show();
                        ...
                        if (hasPermissions()) {
                            ...
                            if (myl.size() > 0) {
                                Toast.makeText(Registration2otp.this, "the provided username already exists, try again", Toast.LENGTH_SHORT).show();
                            } else {
                                ...
                                Registrationtable rt = new Registrationtable(Uname, Pass, Secuhint, SecuanswerS, PhoneNoSend);
                                rt.save();
                                ...
                                if (istracer) {
                                    ...
                                    if (trclist.size() > 0) {
                                        Toast.makeText(Registration2otp.this, "the provided details already exists under tracers", Toast.LENGTH_SHORT).show();
                                    } else {
                                    ...
                                    if (adminlist.size() > 0) {
                                        Toast.makeText(Registration2otp.this, "the provided details already exists under ucsf admins", Toast.LENGTH_SHORT).show();
                                    } else {
                                ...
                                Intent i = new Intent(Registration2otp.this, LoginActivity.class);
                                startActivity(i);
                                finish();
