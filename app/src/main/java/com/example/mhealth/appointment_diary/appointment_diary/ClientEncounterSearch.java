...
public class ClientEncounterSearch extends AppCompatActivity {
   ...
   /* public void onBackPressed() {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_client_encounter_search);


        dialogs=new Dialogs(ClientEncounterSearch.this);
        checkInternet= new CheckInternet(ClientEncounterSearch.this);
        ...
        searchbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (ccno.getText().toString().isEmpty()){
                    Toast.makeText(ClientEncounterSearch.this, "Enter CCC Number", Toast.LENGTH_LONG).show();
                }else if (!checkInternet.isInternetAvailable()){
                    Toast.makeText(ClientEncounterSearch.this, "Check Your Internet Connection", Toast.LENGTH_LONG).show();
...
//                            Toast.makeText(ctx,  ""+error.networkResponse.statusCode+" error mess "+new String(htmlBodyBytes), Toast.LENGTH_SHORT).show();
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(ClientEncounterSearch.this);
