...
public class HtsInconclusiveFragment extends Fragment {
    View v;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        v=inflater.inflate(R.layout.hts_results_inconclusive,container,false);
    ...
    public void initialise(){
        ...
        try{
            ...
            recyclerView = (RecyclerView) v.findViewById(R.id.hts_inconclusive_recycler_view);
    ...
    private void getResults(){
        ...
        try {
            ...
            List<Htsresults> myl=Htsresults.findWithQuery(Htsresults.class,"select * from Htsresults where result=?","Inconclusive");
