...
public class HtsNegativeFragment extends Fragment {
    View v;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        v=inflater.inflate(R.layout.hts_results_negative,container,false);
    ...
    public void initialise(){
        ...
        try{
            ...
            recyclerView = (RecyclerView) v.findViewById(R.id.hts_negative_recycler_view);
