...
public class DefaulteredCallAdapter extends BaseAdapter implements Filterable {



    private Context mycont;
    private List<DefaulteredCallModel> mylist3;
    DefaulteredCallAdapter.CustomFilter filter;
    private List<DefaulteredCallModel> filterList;
    ...
    public View getView(final int position, final View convertView, ViewGroup parent) {
        View v = View.inflate(mycont, R.layout.defaultercall_row, null);
        ...
        try {
            ...
            TextView fileT = (TextView) v.findViewById(R.id.callfileserial);
            ...
            final String ccnumberS=mylist3.get(position).getCcnumber();
            final String appnameS=mylist3.get(position).getThename();
            final String phoneS=mylist3.get(position).getPhone();
            final String informantS=mylist3.get(position).getInformantnumber();
            final String apptypeS=mylist3.get(position).getApptype();
            final String dateS=mylist3.get(position).getDate();
            final String fileS=mylist3.get(position).getFileserial();
            final String patientS=mylist3.get(position).getPatientid();

            //new code here
            final String readcountS=mylist3.get(position).getReadcount();
            final String lastdatereadS=mylist3.get(position).getLastdateread();
            //end new code here
...
//            String[] newapptype={"Select new appointment type","Refill","Clinical review","Enhanced Adherance Counselling","Lab investigation","Other"};
            ...
            if(myl.size()>0){
                ...
                for(int x=0;x<myl.size();x++){
                    ...
                    Button deleteRecord = (Button) v.findViewById(R.id.deldefaulteredcallbtn);
...
//                        start function to delete record from system manually
                        deleteRecord.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                String msgbdy = mylist3.get(position).getCcnumber();
...
//                                Toast.makeText(view.getContext(), "clearing false defaulters", Toast.LENGTH_SHORT).show();
                                String msgbdy = mylist3.get(position).getCcnumber();
                                final String appId=mylist3.get(position).getPatientid();
...
//                            itemselected = parent.getItemAtPosition(position).toString();
                        ...
                        submit.setOnClickListener(new View.OnClickListener()
                        {
                            ...
                            public void onClick(View v)
                            {
                                ...
                                else if(newapptypespinner.isShown() && (new_appointment_type.contentEquals("5")) && nextappOther.getText().toString().isEmpty()){
...
//    }
    ...
    public Filter getFilter() {
        ...
        if(filter==null){
            ...
            filter=new DefaulteredCallAdapter.CustomFilter();
    ...
    class CustomFilter extends Filter{
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            ...
            if(constraint!=null && constraint.length()>0){
                ...
                ArrayList<DefaulteredCallModel> filters=new ArrayList<DefaulteredCallModel>();
