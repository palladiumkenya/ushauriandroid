...
import com.example.mhealth.appointment_diary.adapter.MyAdapter;
...
//        generateAppSignature();
    ...
    private void initialise() {
        ...
        chk=new CheckInternet(EID.this);
        encoder=new Base64Encoder();
        acs=new AccessServer(EID.this);

        fabref = (FloatingActionButton) findViewById(R.id.fabmainres);
        sm = new SendMessage(EID.this);
        pm = new ProcessMessage();
        mc = new makeCalls(EID.this);
               ...
               /* String userPhoneNumber="";
                ...
                if(chk.isInternetAvailable()){
                   ...
                   // acs.getVlEidResultsFromDb(userPhoneNumber);
                    acs.getVlEidResultsFromDb(phone);

                }
                else{

                   // sm.sendMessageApi(encoder.encryptString(userPhoneNumber), Config.mainShortcode);
                    sm.sendMessageApi(encoder.encryptString(phone), Config.mainShortcode);
...
//                bottomNavigation.setNotificationTextColorResource(Color.WHITE);
                ...
                switch (position) {
                    ...
                    case 0:
                        ...
                        pr.progressing(EID.this, "loading..", "Getting All Results");
...
//                        Toast.makeText(getApplicationContext(), "fragment"+myfall, Toast.LENGTH_SHORT).show();
                    ...
                    case 1:
                        ...
                        pr.progressing(EID.this, "loading..", "Getting EID Results");
...
//                        Toast.makeText(getApplicationContext(), "fragment"+myfeid, Toast.LENGTH_SHORT).show();
                    ...
                    case 2:
                        ...
                        pr.progressing(EID.this, "loading..", "Getting VL Results");
...
//                        Toast.makeText(getApplicationContext(), "fragment"+myfvl, Toast.LENGTH_SHORT).show();
                    ...
                    case 3:
                        ...
                        pr.progressing(EID.this, "loading..", "Getting EID Reports");
...
//                        Toast.makeText(getApplicationContext(), "fragment"+myfvl, Toast.LENGTH_SHORT).show();
                    ...
                    case 4:
                        ...
                        pr.progressing(EID.this, "loading..", "Getting VL Reports");
...
//                        Toast.makeText(getApplicationContext(), "fragment"+myfvl, Toast.LENGTH_SHORT).show();
    ...
    public void LoadHeavyStuff() {
        ...
        try {
            progressDialog = new ProgressDialog(EID.this);
                ...
                switch (position) {
                    case 0:
                        if (bottomNavigation.getItem(0).getTitle(getApplicationContext()).toString() == "Suppressed") {
                            ...
                            pr.progressing(EID.this, "loading..", "Getting Suppressed VL Results");
                            Handler mHand = new Handler();
                            mHand.postDelayed(new Runnable() {
...
//
                            ...
                            pr.DissmissProgress();
                            pr.progressing(EID.this, "loading..", "Getting EID monthly Results");
                            Handler mHand = new Handler();
                            mHand.postDelayed(new Runnable() {
...
//
                            ...
                            pr.DissmissProgress();
                            pr.progressing(EID.this, "loading..", "Getting VL monthly Results");
                            Handler mHand = new Handler();
                            mHand.postDelayed(new Runnable() {
...
//
                            ...
                            pr.DissmissProgress();
                            pr.progressing(EID.this, "loading..", "Getting EID Negative Results");
                            Handler mHand = new Handler();
                            mHand.postDelayed(new Runnable() {
                    ...
                    case 1:
                        ...
                        if (bottomNavigation.getItem(1).getTitle(getApplicationContext()).toString() == "UnSuppressed") {
                            ...
                            pr.DissmissProgress();
                            pr.progressing(EID.this, "loading..", "Getting VL Unsuppressed Results");
                            Handler mHand = new Handler();
                            mHand.postDelayed(new Runnable() {
...
//
                            ...
                            pr.progressing(EID.this, "loading..", "Getting EID Yearly Results");
                            Handler mHand = new Handler();
                            mHand.postDelayed(new Runnable() {
...
//
                            ...
                            pr.DissmissProgress();
                            pr.progressing(EID.this, "loading..", "Getting VL yearly Results");
                            Handler mHand = new Handler();
                            mHand.postDelayed(new Runnable() {
...
//
                            ...
                            pr.DissmissProgress();
                            pr.progressing(EID.this, "loading..", "Getting EID Positive Results");
                            Handler mHand = new Handler();
                            mHand.postDelayed(new Runnable() {
...
//                      Toast.makeText(MainActivity.this, ""+bottomNavigation.getItem(1).getTitle(getApplicationContext()), Toast.LENGTH_SHORT).show();
                    ...
                    case 2:
                        ...
                        if (bottomNavigation.getItem(2).getTitle(getApplicationContext()).toString() == "Rejected") {
                            ...
                            pr.progressing(EID.this, "loading..", "Getting VL rejected Results");
                            Handler mHand = new Handler();
                            mHand.postDelayed(new Runnable() {
...
//
                            ...
                            pr.progressing(EID.this, "loading..", "Getting EID Rejected Results");
                            Handler mHand = new Handler();
                            mHand.postDelayed(new Runnable() {
